...
namespace PaymentContext.Domain.Handlers
{
                                                 ...
                                                 , IHandler<CreateCreditCardSubscriptionCommand>
    {
        ...
        public ICommandResult Handle(CreateBoletoSubscriptionCommand command)
        {
            ...
            // Enviar email
            _emailService.Send(student.Name.ToString(), student.Email.Address, "Bem vindo", "Sua assinatura foi criada e paga no boleto");
        ...
        public ICommandResult Handle(CreateCreditCardSubscriptionCommand command)
        {
            ...
            // Enviar email
            _emailService.Send(student.Name.ToString(), student.Email.Address, "Bem vindo", "Sua assinatura foi criada e paga no cartão");
